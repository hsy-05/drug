...
class AddDrugC extends StatefulWidget {

  @override
  _AddDrugCState createState() => _AddDrugCState();
}

class _AddDrugCState extends State<AddDrugC> {
  ...
  DatabaseReference drugC;

  @override
  void initState() {
    super.initState();
    drugC = FirebaseDatabase.instance.reference().child("device1").child("drugC");
  }
    ...
    return new AppBar(
      ...
      actions: [
        new FlatButton(
          onPressed: () async {
            saveContact();
            // drugC.reference().push().set(drugText);
  ...
  void saveContact(){
    ...
    drugC.reference().push().set(toJson);
  }
