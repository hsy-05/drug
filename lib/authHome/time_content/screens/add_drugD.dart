...
class AddDrugD extends StatefulWidget {

  @override
  _AddDrugDState createState() => _AddDrugDState();
}

class _AddDrugDState extends State<AddDrugD> {
    ...
    return new AppBar(
      ...
      actions: [
        new FlatButton(
          onPressed: () async {
            saveContact();
            // drugD.reference().push().set(drugText);
  ...
  void saveContact(){
    ...
    drugD.reference().push().set(toJson);
  }
